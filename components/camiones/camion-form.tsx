...
export function CamionForm({ camion }: CamionFormProps) {
  const [formData, setFormData] = useState({
    ...
    id_fundo: camion?.id_fundo || "none",
    id_lote: camion?.id_lote || "none",
  })
  ...
  useEffect(() => {
    if (formData.id_fundo && formData.id_fundo !== "none") {
      ...
      if (camion?.id) {
        ...
        const { error } = await supabase
          ...
          .update({
            ...
            id_fundo: formData.id_fundo === "none" ? null : formData.id_fundo,
            id_lote: formData.id_lote === "none" ? null : formData.id_lote,
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData({ ...formData, id_fundo: value, id_lote: "none" })}
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  disabled={formData.id_fundo === "none" || loadingLotes}
                >
                  <SelectTrigger>
                    <SelectValue
                      placeholder={
                        formData.id_fundo === "none"
